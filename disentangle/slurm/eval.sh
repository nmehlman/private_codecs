...
#SBATCH --chdir /home1/nmehlman/private_codecs/private_codecs/disentangle/eval
...
srun python eval_uninformed.py --config configs/eval_uninformed_vox1_hificodec.yaml
